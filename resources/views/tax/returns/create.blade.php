...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">File New Tax Return</h1>
        <p class="text-gray-600">For the tax year {{ $filingYear }}</p>
    </div>

    <form action="{{ route('tax.returns.store') }}" method="POST" id="taxReturnForm">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="filing_type" id="filing_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        <option value="individual" {{ old('filing_type', $taxpayerType) === 'individual' ? 'selected' : '' }}>Individual</option>
                        <option value="business" {{ old('filing_type', $taxpayerType) === 'business' ? 'selected' : '' }}>Business</option>
                        <option value="freelancer" {{ old('filing_type', $taxpayerType) === 'freelancer' ? 'selected' : '' }}>Freelancer</option>
                    </select>
                    @error('filing_type')
                ...
                <div>
                    ...
                    <input type="text" id="filing_year" name="filing_year" value="{{ old('filing_year', $filingYear) }}" 
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div id="incomeSourcesContainer">
                ...
                <!-- Initial income source -->
                <div class="income-source mb-4 p-4 border border-gray-200 rounded-md">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div class="md:col-span-4">
                            <select name="income_sources[0][source_type]" class="source-type w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                                <option value="salary">Salary</option>
                                <option value="business">Business Income</option>
                                <option value="rental">Rental Income</option>
                                <option value="interest">Interest Income</option>
            ...
            <div class="mt-4 p-4 bg-gray-50 rounded-md">
                <div class="flex justify-between">
                    ...
                    <span id="totalIncome" class="font-bold">৳0.00</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div id="exemptionsContainer">
                ...
                <!-- Exemptions will be added here -->
            </div>
            
            <div class="mt-4 p-4 bg-gray-50 rounded-md">
                <div class="flex justify-between">
                    <span class="font-medium">Total Exemptions:</span>
                    <span id="totalExemptions" class="font-bold">৳0.00</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="space-y-2">
                <div class="flex justify-between">
                    ...
                    <span id="previewTotalIncome">৳0.00</span>
                </div>
                <div class="flex justify-between">
                    <span>Total Exemptions:</span>
                    <span id="previewTotalExemptions">-৳0.00</span>
                </div>
                <div class="border-t border-gray-200 my-2"></div>
                <div class="flex justify-between font-medium">
                    <span>Taxable Income:</span>
                    <span id="previewTaxableIncome">৳0.00</span>
                </div>
                <div class="flex justify-between font-medium text-lg mt-4">
                    <span>Estimated Tax:</span>
                    <span id="previewTaxAmount" class="text-blue-600">৳0.00</span>
                </div>
            </div>
        </div>
